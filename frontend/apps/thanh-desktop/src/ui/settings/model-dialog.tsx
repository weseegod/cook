...
export function ModelDialog({
  ...
  return (
    <Dialog
      ...
      description={editing
        ? "Saved to ~/.thanh/config.toml and used by the agent after its config refresh."
        : `Pick an id from ${provider.name ?? provider.id}, or type one. Saved to ~/.thanh/config.toml.`}
      size="wide"
      onClose={onClose}
    >
      <form
