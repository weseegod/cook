...
const SEED_PLAN: &str = "# Plan: Test a complete mixed batch plan\n\n## Goal kind\ncode-change\n\n## Decisions\n- OLD mixed-batch decision unique-c91e04.\n\n## Context\n- The plan is file-backed.\n- Edits run before exit.\n- Approval reads the file.\n\n## Acceptance criteria\n1. The snapshot sees the edit.\n\n## Verification plan\n1. gating: run `cargo test` and observe the snapshot.\n\n## Non-goals\n- Other edits.\n\n## Assumed scope\n- `plan.md`\n\n## Implementation approach\nSerialize the batch.\n\n## Current anchors\n- `plan.md` `new:seed_plan` observed: file is about to be written with this content.\n- `tests/plan.rs` `new:batch_tests` observed: test file does not exist yet.\n\n## Edit brief\n### `plan.md`\n- Now: No plan content exists.\n- Change: Write the seed plan body.\n- Keep: Unique marker preserved.\n- Proof: `cargo test plan_exit_batch`\n\n### `plan.md`\n- Now: No snapshot is taken yet.\n- Change: Request review after the edit.\n- Keep: Snapshot matches the edited body.\n- Proof: `cargo test plan_exit_batch`\n\n### `tests/plan.rs`\n- Now: No batch tests exist.\n- Change: Add batch ordering tests.\n- Keep: Tests drive the real path.\n- Proof: `cargo test plan_exit_batch`\n\n## Task checklist\n- [ ] `plan.md` — edit the decision. Done when: file changes.\n- [ ] `plan.md` — request review. Done when: snapshot matches.\n- [ ] `tests/plan.rs` — test batch ordering. Done when: tests pass.\n\n## Deviations\n(none yet)\n";
