...
pub struct AgentView {
    ...
    /// Still-running watcher cue on the turn-status row (click toggles inline
    /// detail rows; Ctrl+G still opens the tasks pane).
    pub hit_watching_cue: HitArea,
    /// Whether the watching-cue detail rows are expanded below the summary.
    pub watching_cue_expanded: bool,
