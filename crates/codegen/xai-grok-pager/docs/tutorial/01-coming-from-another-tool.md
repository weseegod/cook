...
Fear not — your settings, rules, and skills come with you. Cook
...
Run **`cook inspect`** in a repo to see every rules file, skill, and MCP
server Cook picked up, tagged with where it came from. Each compat source
