...
Cook knows its own capabilities and can configure itself. Try:
...
## Teach Cook your project: AGENTS.md

Drop an `AGENTS.md` file in your repo root with build commands, conventions,
and gotchas. Cook reads it automatically in every session — it's the single
